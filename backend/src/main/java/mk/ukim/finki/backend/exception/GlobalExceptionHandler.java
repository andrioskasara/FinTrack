...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleUnauthorizedTransaction(UnauthorizedTransactionAccessException ex) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(ex.getMessage());
    }

    @ExceptionHandler(BudgetValidationException.class)
    public ResponseEntity<?> handleBudgetValidation(BudgetValidationException ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(ex.getMessage());
    }

    @ExceptionHandler(SavingGoalValidationException.class)
    public ResponseEntity<?> handleSavingGoalValidation(SavingGoalValidationException ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(ex.getMessage());
    }
